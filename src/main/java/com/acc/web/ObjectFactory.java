 ...
 * generated in the com.acc.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://web.acc.com/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://web.acc.com/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.acc.web
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web.acc.com/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://web.acc.com/", name = "helloWorldResponse")
