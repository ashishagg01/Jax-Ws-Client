 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://web.acc.com/", wsdlLocation = "http://localhost:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://web.acc.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://web.acc.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web.acc.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
